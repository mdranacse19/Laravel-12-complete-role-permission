...
class StakeholderPolicy
{
    ...
    {
        return $user->can(Permissions::STAKEHOLDER->permission('access'))
            ? Response::allow()
    ...
    public function create(Authenticatable $user): Response
    {
        ...
        return $user->can(Permissions::STAKEHOLDER->permission('create'))
            ? Response::allow()
    ...
    public function update(Authenticatable $user): Response
    {
        ...
        return $user->can(Permissions::STAKEHOLDER->permission('update'))
            ? Response::allow()
            : Response::deny('You are not allowed to perform this action.');
    }
    ...
    public function delete(Authenticatable $user): Response
    {
        ...
        return $user->can(Permissions::STAKEHOLDER->permission('delete'))
            ? Response::allow()
            : Response::deny('You are not allowed to perform this action.');
    }
}
